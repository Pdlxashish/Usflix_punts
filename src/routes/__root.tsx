  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">The page you're looking for is somewhere else.</p>
        <div className="mt-6">
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/a0d8eaeb-e895-4b93-ae13-54a4b2f2c420/id-preview-3a168c80--10e47b88-7b34-4e21-9c67-9012b9534a98.lovable.app-1778693777946.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/a0d8eaeb-e895-4b93-ae13-54a4b2f2c420/id-preview-3a168c80--10e47b88-7b34-4e21-9c67-9012b9534a98.lovable.app-1778693777946.png" },
...
function AppLayout() {
  ...
  }, [activeProfile, router.state.location.pathname]);
