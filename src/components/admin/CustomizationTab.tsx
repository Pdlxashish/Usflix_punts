...
const SECTIONS: AdminNavSection<SectionId>[] = [
  {
    ...
    shortLabel: "Text",
    icon: Type,
    description: "Site name, titles, footer, and dates",
  },
  {
    id: "colors",
    label: "Color Theme",
  ...
  },
  {
    ...
    shortLabel: "Assets",
    icon: Image,
    description: "Logo and browser favicon",
  },
  {
    id: "typography",
    label: "Typography",
  ...
  },
  {
    ...
    shortLabel: "Hero",
    icon: Film,
    description: "Default hero copy, animation, and banner slides",
  },
  {
    id: "sections",
    label: "Page Sections",
    shortLabel: "Sections",
    icon: LayoutGrid,
    description: "Show or hide homepage blocks",
  },
  {
    id: "background",
    label: "Background",
    shortLabel: "BG",
    icon: Wallpaper,
    description: "Background image, pattern, and gradient",
  },
];
...
const TEXT_FIELDS: {
...
}[] = [
  {
    ...
    label: "Platform name",
    maxLength: 100,
    hint: "Shown in the header logo and browser tab.",
  },
  {
    key: "homePageTitle",
    label: "Home page title",
    maxLength: 100,
    hint: "Used in the <title> tag.",
  },
  {
  ...
  },
  {
    ...
    maxLength: 500,
    multiline: true,
    hint: "Tagline shown in the footer.",
  },
  {
    ...
    maxLength: 50,
    type: "date",
    hint: "Used in the Time Together section.",
  },
];
...
const HERO_TEXT_FIELDS: typeof TEXT_FIELDS = [
  {
    key: "heroTagline",
    label: "Default hero tagline",
    maxLength: 200,
    hint: "Shown when no custom hero banners are active.",
  },
  {
    key: "heroSubtitle",
    label: "Default hero subtitle",
    maxLength: 200,
    hint: "Smaller text below the hero tagline.",
  },
];
    ...
    <div className="space-y-1.5">
      ...
      {multiline ? (
        ...
        <input
          ...
          onChange={(e) =>
            onChange(key, e.target.value ? new Date(e.target.value).toISOString() : "")
          }
      ...
      >
        ...
        >
          {section === "text" && (
            <AdminSectionCard
              title="Site copy"
              description="Names and text across the site (not hero slideshow)."
            >
          ...
          {section === "assets" && (
            <AdminSectionCard
              title="Logo & favicon"
              description="Upload or paste URLs for brand images."
            >
              <div className="space-y-6">
                ...
                <div className="space-y-3">
                  ...
                  {form.faviconUrl && (
                    <div className="flex items-center gap-3 p-3 bg-input/30 border border-border/40 rounded-lg">
                      <img
                        src={getMediaUrl(form.faviconUrl)}
                        alt="Favicon"
                  ...
                  return (
                    <div key={fontKey} className="space-y-2">
                      <label className="text-sm font-medium text-foreground/80">
                        {isHeading ? "Heading font" : "Body font"}
                      </label>
                      <select
                        value={form[fontKey]}
                      ...
                      <div className="p-4 bg-input/30 border border-border/40 rounded-lg">
                        ...
                        {isHeading ? (
                          ...
                          <p className="text-base" style={{ fontFamily: form.bodyFont }}>
          ...
          {section === "hero" && (
            <div className="space-y-4 min-w-0">
              <AdminSectionCard
                title="Default hero text"
                description="Shown when no banner slides are active."
              >
              ...
              <AdminSectionCard
                ...
                description="Hero image motion (videos unchanged)."
              >
              ...
              <div className="rounded-xl border border-primary/20 bg-primary/5 px-4 py-3 flex gap-3 min-w-0">
                ...
                <p className="text-sm text-muted-foreground">
                  <span className="text-foreground font-medium">Banner slides</span> below override
                  the default hero text when at least one is active.
                </p>
              </div>
          ...
          {section === "sections" && (
            <AdminSectionCard
              ...
              description="Show or hide blocks without deleting content."
            >
              <div className="space-y-4">
                {[
                  {
                    key: "showTimeTogetherSection" as const,
                    title: "Time Together",
                    desc: "Relationship duration counter",
                  },
                  {
                    key: "showStoryContinuesSection" as const,
                    title: "Story Continues",
                    desc: "Romantic message section",
                  },
                  {
                    key: "showFeaturedSection" as const,
                    title: "Featured",
                    desc: "Featured albums on the homepage",
                  },
                ].map(({ key, title, desc }) => (
                  <label
                    key={key}
                    className="flex items-start gap-3 cursor-pointer p-3 rounded-lg border border-border/50 hover:border-primary/30 transition-colors"
                  >
                    <input
                      type="checkbox"
                      checked={form[key]}
                    ...
                    <div className="flex items-center gap-3 p-3 bg-input/30 border border-border/40 rounded-lg">
                      <div className="h-16 w-24 rounded bg-muted overflow-hidden shrink-0">
                        {/\.(mp4|mov|webm)$/i.test(form.backgroundImageUrl) ? (
                          <video
                            src={getMediaUrl(form.backgroundImageUrl)}
