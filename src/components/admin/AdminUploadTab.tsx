...
const SECTIONS: AdminNavSection<UploadSection>[] = [
  { id: "quick", label: "Quick Upload", shortLabel: "Quick", icon: Upload, description: "Drop files — auto titles and album placement" },
  { id: "detailed", label: "Detailed Upload", shortLabel: "Detail", icon: FileImage, description: "Full metadata: title, tagline, album, and more" },
];
